...
import ItemData from '../../pages/Admin/Invertory/ItemsList/ItemsData.json'
...
function CreateInvoiceForm() {
    ...
    //         item.itemType.toLowerCase().e.target.value.toLowerCase()    
    //     })
    // }
    ...
    <Card elevation={10} sx={{p:'25px', borderRadius:'10px'}}>
        ...
        >
                ...
                <div>
                    <Button onClick={handleOpenItems}>Add an item <Add/></Button>
