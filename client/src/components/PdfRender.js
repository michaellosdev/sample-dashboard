                ...
                <View  style={{margin: '20px', textAlign:'right'}}>
                    ...
                    <View style={{display: 'flex', flexDirection:'row', justifyContent:'space-between', marginBottom:'20px'}}>
                        ...
                        <Text style={{margin:"5px", textAlign:'left' }}>{!item.estimate ? `INVOICE FROM` : `ESTIMATE FROM`}</Text>
                            <Text style={{margin:"5px", textAlign:'left', fontSize:'12px', fontWeight:'bold'}}>SAMPLE COMPANY</Text>
                            <Text style={{margin:"5px", textAlign:'left', fontSize:'12px'}}>Lic#7171717171717</Text>
                            <Text style={{margin:"5px", textAlign:'left', fontSize:'12px'}}>12345 Sample street, Room 777</Text>
                            <Text style={{margin:"5px",textAlign:'left', fontSize:'12px'}}>Sample city, California 91111</Text>
                        </View>
                        <View style={{width:'50%'}}>
                    ...
                    <View style={{display: 'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center', marginBottom:'20px', backgroundColor:BlueColor_100, color:TextColor_100, padding:'0 10px 0 10px'}}>
                            ...
                            <Text style={{margin:"5px", fontSize:'12px'}}>Unit Price</Text>
                            <Text style={{margin:"5px", fontSize:'12px'}}>Total</Text>
                    </View>
                    ...
                    item.customItems.map((a, index) => {
                        return(
                            ...
                            marginBottom:'10px', marginTop:'10px', borderBottom:`2px solid ${BlueColor_100}`}}>
                                ...
                                <Text style={{width:'20%', textAlign:'center', fontSize:'12px'}}>{a.price}</Text>
                                <Text style={{width:'20%', textAlign:'center', fontSize:'12px'}}>{a.qty}</Text>
                                <Text style={{width:'20%', textAlign:'center', fontSize:'12px'}}>{a.total + '$'}</Text>
                            </View>
                        )
                    })
                : ''}
                <View style={{marginTop:'20px' }}>
                <Text style={{margin:"5px", fontSize:'16px'}}>DISCOUNT {item.discount}</Text>
                <Text style={{margin:"5px", fontSize:'16px'}}>TOTAL PRICE {item.totalPrice}$</Text>
                </View>
