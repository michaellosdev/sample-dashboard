...
function JobDetailsTech() {
    ...
    const invID = job.invoice?._id
 
    const navigate = useNavigate()
    const goToList = () => {
      id && navigate(generatePath("item-list/:invID", {invID}))
    }  
    ...
    <Container sx={ContainerStyles}>
        ...
        <Card elevation={10} sx={{p:'25px', borderRadius:'10px', height:'500px', width:'100%' }}>
            ...
            <div style={{width:'100%', display:'flex', justifyContent:'space-between'}}>
                ...
                <Button variant='contained'sx={{
                    backgroundColor: BlueColor_100,
                    ':hover':{
                        backgroundColor:BlueColor_50,
                        color: BlackColor_100
                    }
                }} onClick={goToList}>GET ITEM LIST</Button>
            </div>
        </Card> 
