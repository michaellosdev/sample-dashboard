...
function CustomerPage() {
    ...
    const handleProceed = (e) => {
        ...
        id && navigate(generatePath("edit-customer/:id", {id}))
    }
        ...
        <Breadcrumbs sx={{marginBottom:'10px'}}>
            ...
            <Card elevation={10} sx={{
                ...
                <div style={{display:'flex', height:'90%'}}>
                    <div style={{width:'50%', height:'100%', display:'flex', flexDirection:'column', alignItems:'center', padding:'10px'}}>
                        <div style={{border:`1px solid ${BlackColor_50}`, borderRadius: '10px', width: '90%', height:'20%', display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 10px 0 10px', marginBottom:'10px' }}>
                            <div >
                                <Typography variant='h4'>{`${customerDetails.firstName} ${customerDetails.lastName}`}</Typography>
                                <Typography variant='caption' sx={{color:BlackColor_25}}>{!customerDetails.company ? '  ' : customerDetails.company}</Typography>
                            </div>
                    ...
                    <div style={{width:'50%', height:'100%',  display:'flex', flexDirection:'column', alignItems:'center', padding:'10px'}}>
                        ...
                        <div style={{width: '90%', height:'40%'}}>
                                <Typography variant='h6'>CUSTOMER REPRESENTATIVE</Typography> 
                                <div style={{border:`1px solid ${BlackColor_50}`, borderRadius: '10px', width: '90%', height:'70%', display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 10px 0 10px', marginBottom:'10px' }}>
                                <div >
                                    <Typography>{customerDetails?.representativeName}</Typography>
                                    <Typography>{customerDetails?.representativeContactPhone}</Typography>
                                    <Typography>{customerDetails?.representativeEmail}</Typography>
                                </div>
                                </div>
                                <div style={{display:'flex', justifyContent:'flex-end'}}>
                                    <ButtonText value='see all' />
                                </div>
                ...
                <div style={{display:'flex',justifyContent:'space-between', width:'100%'}}>
                    <ButtonFilled value='flag cutomer' color={TextColor_100} backgroundColor={RedColor_100} backgroundColor__hover={RedColor_50} color__hover={BlackColor_100} onClick={flagCustomer}/>
                    <div>
